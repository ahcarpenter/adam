...
- [x] **T2: Prettier scoped to md/yml/css**
...
- [x] **T7: lint-staged + husky pre-commit**
...
- [x] **T9: `lib/env.ts` + `.env.example` + tests**
...
- [x] **T11: OTel deps + `agent/instrumentation.ts`**
...
- [x] **T12: Winston-sharing verification (spec risk #1)**
...
- [x] **T13: Extension install as directory mount, chat history only**
...
- [x] **T14: Memory tools + smoke tests**
...
- [x] **T15: Search + cached tool + smoke tests**
...
- [x] **T16: Rate limit in channel auth**
...
- [x] **T19: Push + end-to-end verification**
